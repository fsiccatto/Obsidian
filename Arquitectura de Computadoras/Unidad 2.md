...
Análogamente, toda función puede expresarse como una productoria de todos sus maxterms, afectados cada uno de ellos por un coeficiente que consiste en el valor de la función. Es necesario que la función esté expresada en forma canónica (ya sea en minterms o maxterms).